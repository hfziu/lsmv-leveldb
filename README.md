...
The main interfaces to the DB are declared in `include/leveldb/db.h`. A list of all members of `DB` class is [here](https://rawcdn.githack.com/essethon/leveldb-doc/master/doxygen/html/classleveldb_1_1_d_b.html) (Generated by doxygen). 
